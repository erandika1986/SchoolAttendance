...
{
    public class UserRoleCommandRepository :
        CommandRepository<UserRole>, IUserRoleCommandRepository
    {
        public UserRoleCommandRepository(SchoolAttendanceContext context)
            : base(context)
        {
