...
{
    public class GradeCommandRepository :
        CommandRepository<Grade>, IGradeCommandRepository
    {
        public GradeCommandRepository(SchoolAttendanceContext context) : base(context)
        {
