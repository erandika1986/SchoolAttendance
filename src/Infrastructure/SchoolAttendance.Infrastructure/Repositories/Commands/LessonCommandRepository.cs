...
{
    public class LessonCommandRepository :
        CommandRepository<Lesson>, ILessonCommandRepository
    {
        public LessonCommandRepository(SchoolAttendanceContext context) : base(context)
        {
