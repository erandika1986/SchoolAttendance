...
{
    public class AcademicYearRepository : CommandRepository<AcademicYear>, IAcademicYearRepository
    {
        public AcademicYearRepository(SchoolAttendanceContext context):base(context) 
        {
