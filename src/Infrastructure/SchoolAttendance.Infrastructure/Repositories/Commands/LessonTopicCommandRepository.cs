...
{
    public class LessonTopicCommandRepository : CommandRepository<LessonTopic>, ILessonTopicCommandRepository
    {
        public LessonTopicCommandRepository(SchoolAttendanceContext context) : base(context)
        {
