...
{
    public class ClassCommandRepository :
        CommandRepository<Class>, IClassCommandRepository
    {
        public ClassCommandRepository(SchoolAttendanceContext context) : base(context)
        {
