...
{
    public class LessonTopicQueryRepository  : QueryRepository<LessonTopic>, ILessonTopicQueryRepository
    {
        public LessonTopicQueryRepository(SchoolAttendanceContext context)
            : base(context)
        {
