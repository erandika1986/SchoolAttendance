...
{
    public class AssessmentClassCommandRepository  : CommandRepository<AssessmentClass>, IAssessmentClassCommandRepository
    {
        public AssessmentClassCommandRepository(SchoolAttendanceContext context) : base(context)
        {
