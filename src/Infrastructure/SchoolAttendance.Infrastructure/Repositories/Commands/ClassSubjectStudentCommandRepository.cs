...
{
    public class ClassSubjectStudentCommandRepository : 
        CommandRepository<ClassSubjectStudent>, IClassSubjectStudentCommandRepository
    {
        public ClassSubjectStudentCommandRepository(SchoolAttendanceContext context) : base(context)
        {
