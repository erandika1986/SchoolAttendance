...
namespace SchoolAttendance.Infrastructure.Services
{
  public class ClassService : IClassService
  {
    ...
    public ClassService(ISchoolAttendanceContext db, ILogger<IClassService> logger, IConfiguration config, ICoreDataService coreDataService, IDropDownService dropDownService)
    {
      this.db = db;
      this.logger = logger;
      this.config = config;
    ...
    public ClassMasterDataViewModel GetClassMasterData()
    {
      ...
      response.AllTeachers.AddRange(dropDownService.GetAllTeachers());
